...
class KCutAppCopy extends ConsumerStatefulWidget {
  const KCutAppCopy({super.key});

  @override
  ConsumerState<KCutAppCopy> createState() => _KCutAppState();
}

class _KCutAppState extends ConsumerState<KCutAppCopy> {
  @override
  void initState() {
    super.initState();
    _listenAuthState();
